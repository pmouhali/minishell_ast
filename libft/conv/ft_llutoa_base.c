...
/*   Updated: 2019/03/18 20:49:56 by grochefo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static int		ft_howmanynbr(unsigned long long n, int base)
{
	int			t;
...
static char		*ft_trad(char *str, unsigned long long n, char *base)
{
	int i;
	int t;
	int s;
